...
contract Ownable {
    //  DONE's
    //  1) DONE - create a private '_owner' variable of type address with a public getter function
    //  2) DONE - create an internal constructor that sets the _owner var to the creater of the contract 
    //  3) DONE - create an 'onlyOwner' modifier that throws if called by any account other than the owner.
    //  4) DONE - fill out the transferOwnership function
    //  5) DONE - create an event that emits anytime ownerShip is transfered (including in the constructor)
...
//  1) DONE - create a private '_paused' variable of type bool
//  2) DONE - create a public setter using the inherited onlyOwner modifier 
//  3) DONE - create an internal constructor that sets the _paused variable to false
//  4) DONE - create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
     ...
     * @return string representing the baseURI
     */
    ...
    function _setTokenURI(uint256 tokenId) internal {
        ...
        _tokenURIs[tokenId] = strConcat(_baseURI, uint2strNew(tokenId));
    }
...
contract ERC721MintableComplete is ERC721Metadata("TOTOX", "TOX", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/")
{
